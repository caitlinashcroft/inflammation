...
#     npt.assert_array_equal(np.array([1,1,2]), daily_min(test_array))
...
def test_daily_max(test, expected):
    """test max function for 0s, positive integers, and a mix of positive/negative integers"""
    from inflammation.models import daily_max
...
def test_daily_min(test, expected):
    """test min function for 0s, positive integers, and a mix of positive/negative integers"""
    from inflammation.models import daily_min
